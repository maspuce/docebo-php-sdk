...
/**
 * SkillRoleSaveEvaluationConfigSchema Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SkillRoleSaveEvaluationConfigSchema implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SkillRoleSaveEvaluationConfigSchema';
     ...
     * @param int[] $gl_self_exclude_users Array of users ids to exclude(for self evaluation). It could be also a string of comma-separated users ids.  Default - NULL
     * @return $this
     */
    ...
    /**
     * Sets gl_self_scale
     * @param int $gl_self_scale Scale, that will be used for self evaluations
     * @return $this
     */
     ...
     * @param int[] $gl_manager_exclude_users Array of users ids to exclude(for manager evaluation). It could be also a string of comma-separated users ids.  Default - NULL
     * @return $this
     */
    ...
    /**
     * Sets gl_peers_group
     * @param string $gl_peers_group How are grouped the Evaluations (monthly(1 MONTH), weekly(1 WEEK), every 6 months(6 MONTHS), yearly(1 YEAR), every quarter(3 MONTHS), every 4 months(4 MONTHS))
     * @return $this
     */
     ...
     * @param float $gl_manager_weight Weight, that will be used for manager evaluations; Value should be between 0 and 10
     * @return $this
     */
    ...
    /**
     * Sets gl_self_group
     * @param string $gl_self_group How are grouped the Evaluations (monthly(1 MONTH), weekly(1 WEEK), every 6 months(6 MONTHS), yearly(1 YEAR), every quarter(3 MONTHS), every 4 months(4 MONTHS))
     * @return $this
     */
     ...
     * @param int $gl_self_group_day Self group evaluation number of the day (possible values: weekly - 1 do 7, monthly - 1 do 28, yearly  - 1 do 365)
     * @return $this
     */
     ...
     * @param int $gl_manager_group_day Manager group evaluation number of the day (possible values: weekly - 1 do 7, monthly - 1 do 28, yearly  - 1 do 365)
     * @return $this
     */
     ...
     * @param int[] $gl_peer_exclude_users Array of users ids to exclude(for peer evaluation). It could be also a string of comma-separated users ids.  Default - NULL
     * @return $this
     */
    ...
    /**
     * Sets gl_self_weight
     * @param float $gl_self_weight Weight, that will be used for self evaluations; Value should be between 0 and 10
     * @return $this
     */
     ...
     * @param int $gl_peers_group_day Peer group evaluation number of the day (possible values: weekly - 1 do 7, monthly - 1 do 28, yearly  - 1 do 365)
     * @return $this
     */
    ...
    /**
     * Sets gl_peer_scale
     * @param int $gl_peer_scale Scale, that will be used for peer evaluations
     * @return $this
     */
     ...
     * @param int $gl_show_manager_to_user Is manager assessment will be visible to the user? Options - 1(Yes), 0(No)
     * @return $this
     */
     ...
     * @param string $gl_manager_group How are grouped the Evaluations (monthly(1 MONTH), weekly(1 WEEK), every 6 months(6 MONTHS), yearly(1 YEAR), every quarter(3 MONTHS), every 4 months(4 MONTHS))
     * @return $this
     */
    ...
    /**
     * Sets gl_peer_weight
     * @param float $gl_peer_weight Weight, that will be used for peer evaluations; Value should be between 0 and 10
     * @return $this
     */
     ...
     * @param int $gl_manager_scale Scale, that will be used for manager evaluations
     * @return $this
     */
