...
/**
 * LearnLpViewEcommerce Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LearnLpViewEcommerce implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnLpViewEcommerce';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['purchase_method'] === null) {
            $invalid_properties[] = "'purchase_method' can't be null";
        }
     ...
     * @param int $purchase_method Identifying number of the payment method
     * @return $this
     */
    ...
    /**
     * Sets price
     * @param int $price The price of the learning plan
     * @return $this
     */
    ...
    /**
     * Sets on_sale
     * @param bool $on_sale Whether or not the learning plan is on sale
     * @return $this
     */
