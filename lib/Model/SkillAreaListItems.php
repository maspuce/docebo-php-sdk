...
/**
 * SkillAreaListItems Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SkillAreaListItems implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SkillAreaListItems';
    ...
    /**
     * Sets title
     * @param string $title Area title in the selected language
     * @return $this
     */
    ...
    /**
     * Sets predefined_uid
     * @param string $predefined_uid ID of the predefined area, populated only if the area is not user defined
     * @return $this
     */
