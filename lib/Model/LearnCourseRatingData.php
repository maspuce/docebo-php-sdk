...
/**
 * LearnCourseRatingData Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LearnCourseRatingData implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnCourseRatingData';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['average_rating'] === null) {
            $invalid_properties[] = "'average_rating' can't be null";
        }
    ...
    /**
     * Sets average_rating
     * @param float $average_rating The average rating for this course
     * @return $this
     */
