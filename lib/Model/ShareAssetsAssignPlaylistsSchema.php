...
/**
 * ShareAssetsAssignPlaylistsSchema Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ShareAssetsAssignPlaylistsSchema implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShareAssetsAssignPlaylistsSchema';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['playlist_ids'] === null) {
            $invalid_properties[] = "'playlist_ids' can't be null";
        }
    ...
    /**
     * Sets playlist_ids
     * @param int[] $playlist_ids Playlist ids to be assigned
     * @return $this
     */
