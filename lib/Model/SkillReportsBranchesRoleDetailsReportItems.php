...
/**
 * SkillReportsBranchesRoleDetailsReportItems Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SkillReportsBranchesRoleDetailsReportItems implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SkillReportsBranchesRoleDetailsReportItems';
    ...
    {
        $this->container['user_surname'] = isset($data['user_surname']) ? $data['user_surname'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['user_surname'] === null) {
            $invalid_properties[] = "'user_surname' can't be null";
        }
    ...
    /**
     * Sets user_surname
     * @param string $user_surname User last name
     * @return $this
     */
