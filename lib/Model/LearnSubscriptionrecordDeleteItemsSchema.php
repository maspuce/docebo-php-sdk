...
/**
 * LearnSubscriptionrecordDeleteItemsSchema Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LearnSubscriptionrecordDeleteItemsSchema implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnSubscriptionrecordDeleteItemsSchema';
    ...
    /**
     * Sets item_ids
     * @param int[] $item_ids ID of item/s to be deleted
     * @return $this
     */
