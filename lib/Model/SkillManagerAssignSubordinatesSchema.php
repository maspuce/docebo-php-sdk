...
/**
 * SkillManagerAssignSubordinatesSchema Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SkillManagerAssignSubordinatesSchema implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SkillManagerAssignSubordinatesSchema';
    ...
    /**
     * Sets hierarchy
     * @param int $hierarchy Type of manager (1 for Direct manager, other codes reserved for future improvements) default - 1
     * @return $this
     */
    ...
    /**
     * Sets user_ids
     * @param int[] $user_ids Ids of users to assign as subordinates to a manager
     * @return $this
     */
