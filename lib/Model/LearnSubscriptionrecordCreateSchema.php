...
/**
 * LearnSubscriptionrecordCreateSchema Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LearnSubscriptionrecordCreateSchema implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnSubscriptionrecordCreateSchema';
    ...
    protected static $swaggerTypes = [
        'code' => 'string',
        'items' => '\Swagger\Client\Model\LearnSubscriptionrecordCreateItems',
        'object_type' => 'int',
        'availability' => 'int',
        'start_date' => '\DateTime',
        'type' => 'int',
    ...
    /**
     * Gets items
     * @return \Swagger\Client\Model\LearnSubscriptionrecordCreateItems
     */
    ...
    /**
     * Sets items
     * @param \Swagger\Client\Model\LearnSubscriptionrecordCreateItems $items Array with keys subscription record item id and value item type (options: 1 - course, 2 - catalog, 3 - learning plan)
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param int $type Subscription record type (1 - licenses or 2 - seats)
     * @return $this
     */
     ...
     * @param int $selection_status Subscription record object selection status - 1 - Single, 2 - with children
     * @return $this
     */
    ...
    /**
     * Sets renewal
     * @param int $renewal Subscription record renewal
     * @return $this
     */
    ...
    /**
     * Sets price
     * @param int $price Subscription record price. If price is not privided it will be taken from the Subscrioption plan
     * @return $this
     */
    ...
    /**
     * Sets status
     * @param int $status Subscription record status (1 - active or 2 - inactive). Default is &quot;active&quot;
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name Subscription record name - if it is not provided it will be taken from Subscription bundle name
     * @return $this
     */
