...
/**
 * LearnCatalogueIndexSubItems Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LearnCatalogueIndexSubItems implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnCatalogueIndexSubItems';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['item_price'] === null) {
            $invalid_properties[] = "'item_price' can't be null";
        }
    ...
    /**
     * Sets item_id
     * @param int $item_id Catalogue item ID - course or Learning plan ID
     * @return $this
     */
    ...
    /**
     * Sets item_category
     * @param int $item_category Catalogue item category
     * @return $this
     */
    ...
    /**
     * Sets item_type
     * @param string $item_type Catalogue item type - Course or Learning plan
     * @return $this
     */
     ...
     * @param int $item_can_enroll Catalogue item can enroll (0 - Only Admin can subscribe, 1 - Pending Admin Approval OR 2 - Free  )
     * @return $this
     */
    ...
    /**
     * Sets item_thumbnail
     * @param string $item_thumbnail Catalogue item thumbnail
     * @return $this
     */
     ...
     * @param int $item_visibility Catalogue item visibility (0 - Everyone, and show on home page, 1 - Only for logged in users OR 2 - Only users subscribed to the course)
     * @return $this
     */
    ...
    /**
     * Sets item_name
     * @param string $item_name Catalogue item name
     * @return $this
     */
    ...
    /**
     * Sets item_code
     * @param string $item_code Catalogue item code
     * @return $this
     */
    ...
    /**
     * Sets item_policy
     * @param int $item_policy Catalogue item policy (0 - Subscriptions are closed, 1 Subscriptions are open OR 2 Subscription is available during the following period)
     * @return $this
     */
     ...
     * @param string $item_description Catalogue item description
     * @return $this
     */
    ...
    /**
     * Sets item_price
     * @param int $item_price Catalogue item price (available only if &quot;ecommerce&quot; app is activated, otherwise NULL will be returned)
     * @return $this
     */
    ...
    /**
     * Sets item_language
     * @param string $item_language Catalogue item language (available only for Courses, otherwise NULL will be returned)
     * @return $this
     */
    ...
    /**
     * Sets item_rating
     * @param int $item_rating Catalogue item rating (available only for Courses, otherwise NULL will be returned). Not available for Generic catalog
     * @return $this
     */
