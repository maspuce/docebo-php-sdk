...
/**
 * LearnSubscriptionseatassociationCreateSchema Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LearnSubscriptionseatassociationCreateSchema implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LearnSubscriptionseatassociationCreateSchema';
    ...
    protected static $swaggerTypes = [
        'record_id' => 'int',
        'item_ids' => '\Swagger\Client\Model\LearnSubscriptionseatassociationCreateItemIds[]',
    ...
    /**
     * Gets item_ids
     * @return \Swagger\Client\Model\LearnSubscriptionseatassociationCreateItemIds[]
     */
    ...
    /**
     * Sets item_ids
     * @param \Swagger\Client\Model\LearnSubscriptionseatassociationCreateItemIds[] $item_ids IDs of the user item_ids = user_ids, IDs of the branch = branch_ids or IDs of the group = group_ids.
     * @return $this
     */
    ...
    /**
     * Sets seat_end_date
     * @param \DateTime $seat_end_date Date when the seat expires. It will be by default the end of the subscription record it refers to. Date format - yyyy-MM-dd HH:mm:ss
     * @return $this
     */
