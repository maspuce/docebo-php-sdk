...
/**
 * SkillTrainingrequestsListByDetailItems Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SkillTrainingrequestsListByDetailItems implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SkillTrainingrequestsListByDetailItems';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['request_date'] === null) {
            $invalid_properties[] = "'request_date' can't be null";
        }
    ...
    /**
     * Sets request_type
     * @param string $request_type Type of training request
     * @return $this
     */
    ...
    /**
     * Sets request_date
     * @param string $request_date Created training request date
     * @return $this
     */
