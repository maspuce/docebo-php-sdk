...
**items** | [**\Swagger\Client\Model\LearnSubscriptionseatassociationIndexItems**](LearnSubscriptionseatassociationIndexItems.md) | Array of subscription seat associations info objects | 
