...
**items** | [**\Swagger\Client\Model\LearnSubscriptionbundleGetCoursesLpsItems**](LearnSubscriptionbundleGetCoursesLpsItems.md) | Array of subscription records info objects | 
