...
**items** | [**\Swagger\Client\Model\LearnSubscriptionseatassociationListSeatsByUserItems**](LearnSubscriptionseatassociationListSeatsByUserItems.md) | Array of subscription seat associations info objects | 
