...
**items** | [**\Swagger\Client\Model\SkillEvaluationListEvaluationSkillsItems**](SkillEvaluationListEvaluationSkillsItems.md) | Array of users in the role info objects | 
