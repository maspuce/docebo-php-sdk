...
**items** | [**\Swagger\Client\Model\SkillEvaluationGetEvaluationRequestsItems[]**](SkillEvaluationGetEvaluationRequestsItems.md) | Array of evaluation requests info objects | 
